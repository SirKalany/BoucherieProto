              ...
              <div className="space-y-6">
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">123 Rue de la Boucherie</p>
                    <p className="text-gray-600">85190 Aizenay, France</p>
                  </div>
                </div>
                ...
                <div className="flex items-start">
                  ...
                  <div className="ml-4">
                    ...
                    <p className="text-gray-600">contact@boucherie-locale.fr</p>
                  </div>
                </div>
              </div>
            </div>
